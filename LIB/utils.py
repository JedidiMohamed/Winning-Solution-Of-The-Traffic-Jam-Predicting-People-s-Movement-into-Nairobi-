...
def predict_1(test_pred):

    for K,v in zip(map_dict.keys(),map_dict.values()):
        test_pred.loc[test_pred.ride_id.isin(v),"number_of_ticket"]=K
    return test_pred
...
map_dict={
      45:[13887, 13956, 14041, 14423, 14651, 14720, 14884], 
      30 : [473, 485, 2363, 3614, 4981] ,
     31:[14648, 14893, 15110],
     19:[13843, 13893, 13985, 14832, 14980],
     11:[1633, 1636, 1675, 2437, 3717],
     38:[13842, 13960, 14584, 15242],
     2:[14051, 14457, 15250],
     26:[13848, 13892, 13968, 14653, 14734],
     1:[15196, 15203,13988, 14023,13854, 13901, 13936, 14270, 14402, 14560, 14565, 14692],
     27:[14061, 14147, 14311, 14437, 14594, 14660, 15302],
     6:[15106, 15167, 15277],
     42 : [14146, 15004, 15231],
     10:[14115, 14190, 14295, 14530, 14969, 15201, 15267],
     3:[13840, 15187, 15303]    
}
